...
this._gl=gl;gl.enable(gl.DEPTH_TEST);gl.depthFunc(gl.LEQUAL);gl.enable(gl.CULL_FACE);var angle_instanced_arrays_ext=gl.getExtension("ANGLE_instanced_arrays");if(!angle_instanced_arrays_ext){console.error('WebGL does not support ANGLE_instanced_arrays required by WebGLSpins');return;}
